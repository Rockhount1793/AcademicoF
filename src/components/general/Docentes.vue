...
<div class="mt-2 h-[90%] pb-2 flex w-auto lg:px-2">
    <div class="rounded border border-gray-300 h-auto w-full">
        ...
        <div v-if="seccion == 1" class="mt-3 p-1 px-2">
            ...
            <div class="mt-3 p-2 flex-1  lg:grid lg:grid-cols-2 lg:gap-2">
                <div class="w-full lg:w-3/4">
                    <button @click="clearForm(); seccion = 0" class="w-full mr-4  lg:w-32 mt-3 mb-3 h-7 shadow shadow-indigo-500 rounded bg-white text-indigo-600 px-2 ">
                        Cancelar
                    </button>
                </div>
                <div class="w-full lg:w-3/4  flex justify-end">
                    <button @click="guardar_actualizar()" class="lg:float-left w-full lg:w-32 mt-3 mb-3 h-7 shadow shadow-indigo-500 rounded bg-indigo-800 text-gray-50 px-2">
