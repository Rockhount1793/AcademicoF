    ...
    <div class="">
        ...
        <div class="mt-2 min-h-full flex w-auto px-2 md:space-x-2">
            ...
            <div class="ml-2 p-1 rounded border border-gray-600 h-auto w-full">
                ...
                <p class="text-gray-100 text-center font-semibold text-lg">Matriculas <span v-if="asignatura.asignatura_id > 0">{{asignatura.nombre}} </span></p>
                ...
                <div class="mt-3 space-y-2 lg:space-y-0 flex-1 lg:flex lg:space-x-2 px-2">
                    ...
                    <p v-if="seccion == 1 && logros.length" @click="set_aprobado(true)" :class="aprobado ? 'bg-pink-800':'bg-pink-400' " class="shadow-pink-500 shadow-md w-32 cursor-pointer rounded  text-center h-7 leading-6 text-gray-100 font-semibold text-md"> Aprobado</p>
                    <p v-if="seccion == 1 && logros.length" @click="set_aprobado(false)" :class="!aprobado ? 'bg-pink-800':'bg-pink-400' " class="shadow-pink-500 shadow-md w-32 cursor-pointer rounded  text-center h-7 leading-6 text-gray-100 font-semibold text-md"> No Aprobado</p>
                </div>
