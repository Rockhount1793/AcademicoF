    ...
    <div class="">
        ...
        <div class="mt-2 h-5/6 flex w-auto px-2 md:space-x-2">
            ...
            <div class="ml-2 p-1 rounded border border-gray-600 h-auto w-full">
                ...
                <p class="text-gray-500 text-center font-semibold text-lg">Matriculas <span v-if="actual_grado.grado_id > 0">{{actual_grado.nombre}} </span></p>
                        ...
                        <li :key="index" v-for="(item, index, key) in matriculas ">
                            ...
                            <div class="lg:space-x-2 px-2 mb-2 flex-1 lg:flex lg:items-center ">
                                ...
                                <div class="w-full h-8 truncate">
                                    <button title="eliminar matricula" @click="delete_(item)" class="mt-0.5 h-6 px-2 rounded shadow-md shadow-pink-500  bg-pink-800 text-gray-500 font-semibold">
