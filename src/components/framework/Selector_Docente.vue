...
<script lang="js">
    ...
    export default defineComponent({
        ...
        setup(props, { emit }){
            ...
            const directores = computed(()=>{ return Store.state.docentes })
            ...
            const directores_com = computed(()=>{
                ...
                if(temp_n.length >= 1){
                    ...
                    return Store.state.docentes.slice(0,500)
                }
            ...
            const director_select = computed(()=>{
                ...
                let directores = Store.state.docentes

                let temp = {'docente_id':0,'nombres':'Director','apellidos':''}

                if(director_id.value > 0){
                    temp = directores.find((p)=>p.docente_id == director_id.value)
                }
