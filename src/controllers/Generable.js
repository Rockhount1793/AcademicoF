...
const Controller = {
    ...
    'boletin_todos_file': async function(){
    ...
    'boletin_final_todos_file': async function(){
    ...
    'informe_final_todos_file': async function(){
    ...
    'certificado_final_file': async function(matricula){
    ...
    'boletin_estudiante_file': async function(params){
    ...
    'certificado_estudio_file_front': async function (matricula) {
